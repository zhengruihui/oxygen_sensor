...
/***************----- W5500 GPIO定义 -----***************/
// #define W5500_RST BIT2	//定义W5500的RST引脚
// //#define W5500_INT BIT3;	//定义W5500的INT引脚
...
/*#define		W5500_RST_PIN_NUM			(BIT0)
#define		W5500_RST_IO_INIT		        (Set_Bit(P2DIR,W5500_RST_PIN_NUM))
#define		W5500_RST_Set()				(Set_Bit(P2OUT,W5500_RST_PIN_NUM))
#define		W5500_RST_Clr()				(Clr_Bit(P2OUT,W5500_RST_PIN_NUM))*/

#define		W5500_RST_PIN_NUM			(BIT3)
#define		W5500_RST_IO_INIT		        (Set_Bit(P6DIR,W5500_RST_PIN_NUM))
#define		W5500_RST_Set()				(Set_Bit(P6OUT,W5500_RST_PIN_NUM))
#define		W5500_RST_Clr()				(Clr_Bit(P6OUT,W5500_RST_PIN_NUM))


#define         W5500_SCS_PIN_NUM (BIT4)	//定义W5500的CS引脚
#define		W5500_CS_IO_INIT		        (Set_Bit(P6DIR,W5500_SCS_PIN_NUM))
#define		W5500_CS_Set()				(Set_Bit(P6OUT,W5500_SCS_PIN_NUM))
#define		W5500_CS_Clr()				(Clr_Bit(P6OUT,W5500_SCS_PIN_NUM))


//#define W5500_SCLK BIT3;	//定义W5500的SCLK引脚
//#define W5500_MISO_IN   P1DIR &=~BIT4;	//定义W5500的MISO引脚
//#define W5500_MISO_read P1IN & BIT4;
//#define W5500_MOSI BIT5;	//定义W5500的MOSI引脚
...
/***************----- 端口数据缓冲区 -----***************/
extern unsigned char Rx_Buffer[50];	//端口接收数据缓冲区 
extern unsigned char Tx_Buffer[50];	//端口发送数据缓冲区 
